...
export default function ListProduto () {
    ...
    function carregarLista() {
        ...
        axios.get("http://localhost:8087/api/produto")
        .then((response) => {
            setListaProdutos(response.data);
        })

        axios.get("http://localhost:8087/api/categoriaproduto")
        .then((response) => {
    ...
    async function remover() {
        ...
        await axios.delete('http://localhost:8087/api/produto/' + idRemover)
        .then((response) => {
    ...
    async function filtrarProdutos(codigoParam, tituloParam, idCategoriaParam) {
        ...
        await axios.post("http://localhost:8087/api/produto/filtrar", formData)
        .then((response) => {
            setListaProdutos(response.data)
        })
    }
